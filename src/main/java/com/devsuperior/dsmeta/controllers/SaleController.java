...
public class SaleController {
    ...
    public ResponseEntity<Page<SalesMinDTO>> getReport(@RequestParam(name = "minDate", required = false) String minDate,
    ...
    public ResponseEntity<?> getSummary(@RequestParam(name = "minDate") String minDate,
